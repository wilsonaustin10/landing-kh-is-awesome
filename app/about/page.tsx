      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="bg-white p-8 rounded-lg shadow-lg space-y-6">
          ...
          <p className="text-gray-700 leading-relaxed mb-6">
            At CKH IS AWESOME>, we're more than just property investors – our team has a genuine passion for helping families navigate through difficult situations. We understand that life can throw unexpected challenges your way, and selling your home quickly might be necessary during these times.
          </p>
